const SearchFilter = () => {
  return (
    <div className="py-10 grid grid-cols-3 gap-8 justify-between items-end">
      {/* 1st Item - Search */}
      <div>
        <form action="#">
      ...
      <div className="col-start-3 col-span-2 flex flex-col">
        <div className="flex row-row gap-2 items-center justify-end mb-2">
          <input
            id="upcomingLaunches"
        ...
        <div className="flex flex-row gap-4 justify-between">
          <div>
            <select
              ...
              className="rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600"
            >
